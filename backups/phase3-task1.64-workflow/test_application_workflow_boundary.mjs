...
async function run() {
  ...
  await test('（TASK1.65後更新）（7.runtime isolation）src/bootstrap/application.js的intelligence物件恰好具備21個欄位（TASK1.63既有19個加上TASK1.64新增的workflow、TASK1.65新增的features）', async () => {
