...
async function run() {
  ...
  const EXPECTED_FILES = ['PHASE4_CAPABILITY_PLAN.md', 'PHASE4_CONSOLIDATION_REVIEW.md', 'PHASE4_DECISION_CAPABILITY_REVIEW.md', 'PHASE4_DECISION_FLOW_PLAN.md', 'README.md', 'analysis_engine.js', 'contracts.js', 'index.js', 'insight_service.js', 'recommendation_engine.js'];
  ...
  await test(`（TASK1.82後更新）src/intelligence/ 底下的檔案（不含子目錄）恰好是TASK1.40規格要求的6個加上TASK1.75/1.80/1.81/1.82新增的4份Phase 4規劃/審查文件`, () => {
