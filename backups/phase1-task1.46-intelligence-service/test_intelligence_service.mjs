...
async function run() {
  ...
  await test('（12.bootstrap injection）app.intelligence 恰好具備 insightService/analysisEngine/recommendationEngine/dataPreparation/context/analysis/recommendation/orchestration/service 九個欄位', () => {
    const app = createApplication(makeFullEnv());
