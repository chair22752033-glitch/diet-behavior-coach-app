...
async function run() {
  ...
  await test('（10.bootstrap injection）app.intelligence 恰好具備 insightService/analysisEngine/recommendationEngine/dataPreparation/context/analysis/recommendation 七個欄位', () => {
    const app = createApplication(makeFullEnv());
