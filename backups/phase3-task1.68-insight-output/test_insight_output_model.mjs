...
async function run() {
  ...
  await test('（TASK1.69後更新）（5.runtime isolation）src/bootstrap/application.js的intelligence物件維持24個欄位不變（本次任務TASK1.68本身沒有新增bootstrap欄位；TASK1.69新增了insightExecutionFlow，是後續任務的合法擴充，不是TASK1.68造成的回歸）', async () => {
