...
async function run() {
  ...
  await test('（TASK1.66後更新）（7.runtime isolation）src/bootstrap/application.js的intelligence物件恰好具備22個欄位（TASK1.64既有20個加上TASK1.65新增的features、TASK1.66新增的insightFeature）', async () => {
